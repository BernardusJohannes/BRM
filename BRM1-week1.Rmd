...
question_7 <- function() {
  ...
  # write your code here
print(plot(df$Q262[df$Country == "ECU"], ds$Q50[ds$Country == "DEU"], xlab = "respondents' age",
       ylab = "satisfaction in financial situation", main = "Country: Germany"))
       
 print(plot(df$Q262[df$Country == "HKG"], ds$Q50[ds$Country == "GTM"], xlab = "respondents' age",
...
question_8 <- function() {
  ...
  g1 <- ggplot(data = ds, mapping = aes(x = Q262, y = Q50, col = Country)) + geom_point() + geom_smooth(method = "lm") + labs(x = "respondents' age", y = "satisfaction in financial situation")
  
  print(g1(data = ds, mapping = aes(x = Q262, y = Q50, col = Country)) + geom_point() + geom_smooth(method = "lm") + labs(x = "respondents' age", y = "satisfaction in financial situation"))
