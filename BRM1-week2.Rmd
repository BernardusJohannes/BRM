...
items <- items
cor(df[df$Country == country1,items], use = "pairwise.complete.obs")
cor(df[df$Country == country2,items], use = "pairwise.complete.obs")
...
emanci <- apply(c("Q28R", "Q29R", "Q30R", "Q31R", "Q32R", "Q33R", "Q35R")], 2, mean, na.rm =TRUE)
